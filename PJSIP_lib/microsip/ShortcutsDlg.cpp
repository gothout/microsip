...
BEGIN_MESSAGE_MAP(ShortcutsDlg, CDialog)
	...
	ON_BN_CLICKED(IDC_SHORTCUTS_TOGGLE9, OnBnClickedToggle)
	ON_BN_CLICKED(IDC_SHORTCUTS_TOGGLE10, OnBnClickedToggle)
	ON_BN_CLICKED(IDC_SHORTCUTS_TOGGLE11, OnBnClickedToggle)
